...
features:add(SpatialConvolution(192,384,5,5,1,1,1,1))      --  13 ->  13
features:add(cudnn.ReLU(true))
features:add(SpatialConvolution(384,256,5,5,1,1,1,1))      --  13 ->  13
features:add(cudnn.ReLU(true))
features:add(SpatialConvolution(256,256,5,5,1,1,1,1))      --  13 ->  13
features:add(cudnn.ReLU(true))
